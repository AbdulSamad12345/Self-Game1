...
function Life(){
  life = createSprite(windowWidth/2+100,50,20,20);
  life.addImage(lifeImg);
  life.scale = 0.1;

  life1 = createSprite(windowWidth/2-150,50,20,20);
  life1.addImage(lifeImg);
  life1.scale = 0.1;

  life2 = createSprite(windowWidth/2-100,50,20,20);
  life2.addImage(lifeImg);
  life2.scale = 0.1;

  life3 = createSprite(windowWidth/2-50,50,20,20);
  life3.addImage(lifeImg);
  life3.scale = 0.1;

  life4 = createSprite(windowWidth/2,50,20,20);
  life4.addImage(lifeImg);
  life4.scale = 0.1;

  life5 = createSprite(windowWidth/2+50,50,20,20);
